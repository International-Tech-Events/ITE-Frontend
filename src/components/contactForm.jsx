  ...
  return (
    <div className="container mx-auto py-12 px-4 font-serif">
      <div className="flex flex-col lg:flex-row lg:space-x-8">
        {/* Contact Information */}
        <div className="ml-40 lg:w-1/3 mb-8 lg:mb-0 left-3">
          <SubContact
        ...
        {/* Contact Form */}
        <div className="w-full lg:w-2/3 lg:pl-12 mr-40">
          <form className="grid grid-cols-1 lg:grid-cols-2 gap-4">
            <div className="flex flex-col">
              <input
                type="text"
                placeholder="Enter your name"
                className="border border-gray-300 pl-2 py-2 text-[12px] rounded outline-none focus:border-purple-500"
              />
              <input
                type="email"
                placeholder="Enter email address"
                className="border border-gray-300 pl-2 py-2 text-[12px] rounded outline-none mt-4 focus:border-purple-500"
              />
              <input
                type="text"
            ...
            <div className="flex flex-col lg:row-span-3">
              <textarea
                ...
                className="border border-gray-300 p-3 rounded outline-none h-[80%] text-[12px] focus:border-purple-500"
              ></textarea>
            </div>
          </form>
